	...
	<section class="rt_wrap content mCustomScrollbar">
		<div class="rt_content">
			<div align="center">
				<br>
				<div align="center">
					<input class="btn" type="button" value="Create Java Bean" onclick="createJavaCodeInExcel()">&nbsp;&nbsp;&nbsp;&nbsp;
					<input class="btn" type="button" value="Create Sql" onclick="createSqlInExcel()">
				</div>
				<br>
				<table border="1" bordercolor="#DDDDDD" style="table-layout: fixed; border-collapse: collapse; width: 60%;">
					<thead>
						<tr>
							...
							<th style="width: 45%">Sheet Remark</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${sheetList}" var="table">
							<tr>
